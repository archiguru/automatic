...
sudo apt-get install build-essential zsh screen zip unzip wget rsync bzip2 lsof telnet git tree htop vim net-tools universal-ctags apt-transport-https ca-certificates curl software-properties-common gcc gcc-11-locales debian-keyring autoconf automake make libtool flex bison gdb bzr libgd-tools expect lrzsz chrony gsmartcontrol hwloc psmisc -y
